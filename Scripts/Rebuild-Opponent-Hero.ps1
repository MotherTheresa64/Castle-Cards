...
Write-Host ""
Write-Host "=== Castle Cards Opponent Hero V4 ===" -ForegroundColor Cyan
...
$generator = Join-Path $projectRoot "ArtSource\Blender\Scripts\generate_opponent_hero_v4.py"
$sourceBlend = Join-Path $projectRoot "ArtSource\Blender\HeroSources\opponent_hero_v4.blend"
...
Write-Host "Running generate_opponent_hero_v4.py..." -ForegroundColor DarkGray
& $blender --background --python $generator
if ($LASTEXITCODE -ne 0) { throw "Opponent hero V4 generation failed." }
...
Write-Host ""
Write-Host "Opponent V4 generated successfully." -ForegroundColor Green
...
Write-Host "Editable source: ArtSource\Blender\HeroSources\opponent_hero_v4.blend" -ForegroundColor Green
Write-Host "Opening the editable V4 source in Blender..." -ForegroundColor Green
